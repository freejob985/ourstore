        ...
        <div class="container">
            <div class="row gutters-10 position-relative">
                                ...
                                <li class="minw-0 col-4 col-md mt-3">
                                    <a href="{{ route('products.category', $category->slug) }}" class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                        <img
                                            ...
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';"
                                        >
                                        <div class="text-center fs-12 fw-600 mt-2 opacity-70">{{ $category->getTranslation('name') }}</div>
                                    </a>
                                </li>
                            @endforeach
                        </ul>
                ...
                @if($num_todays_deal > 0)
                                                @dd("Catch errors for script and full tracking ( 1 )".$num_todays_deal);

                <div class="col-lg-12 order-3 mt-3" style="margin-top:44px;">
                    <div class="bg-white rounded shadow-sm">
                        </br>
                        <div style="display:inline!important;" class="bg-soft-primary rounded-top p-3 d-flex align-items-center justify-content-center">
                            <span   class="fw-600 fs-16 mr-2 text-truncate">
                                {{ translate('Todays Deal') }}
                            </span>
                            <span class="badge badge-primary badge-inline">{{ translate('sale') }}</span>
                        </div>
                        </br></br>
                        <div class="c-scrollbar-light overflow-auto h-lg-400px p-2  rounded-bottom" style="margin-top:24px;">
                            ...
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->get() as $key => $product)
                                @if ($product != null)
                                <div class="col-lg-3">
                                    <a style="margin:12px;" href="{{ route('product', $product->slug) }}" class="d-block p-2 text-reset bg-white mb-2 rounded">
                                        <div class="row gutters-5 align-items-center" >
                                            <div class="col-md-7">
                                                <div class="img">
                                                    <img
                                                        class="lazyload img-fit h-140px h-lg-140px"
                                                        src="{{ static_asset('assets/img/placeholder.jpg') }}"
        ...
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    ...
                    <div class="aiz-count-down ml-auto ml-lg-3 align-items-center" data-date="{{ date('m/d/Y', $flash_deal->end_date) }}"></div>
                ...
                <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="1" data-xs-items="1" data-arrows='true' data-infinite='true'>
                    ...
                    @foreach ($banner_1_imags as $key => $value)
                        <div class="col-xl col-md-6">
                            <div class="mb-3 mb-lg-0">
                                <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}" target="_blank" class="d-block text-reset">
